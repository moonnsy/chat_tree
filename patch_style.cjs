...
const pairs = [
    [
        ...
        '<h3 style="margin-top:0; color:#8db7d5; font-family: \'Caveat\', cursive; font-size: 24px; letter-spacing: 0.5px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 8px;">Предпросмотр сообщения</h3>'
    ],
    [
        ...
        'background:#8db7d5; color:#111; border:none; border-radius:5px; cursor:pointer; font-weight:bold;">ПЕРЕПРЫГНУТЬ ДИАЛОГ СЮДА</button>'
    ],
    [
