...
const jumpBtnNew = '<button id="ct-jump-btn" data-id="${id}" style="flex:1; padding:10px; background:#98FB98; color:#111; border:none; border-radius:5px; cursor:pointer; font-weight:bold; font-size:16px;">ПРЫЖОК</button>';
...
const titleNew = '<h3 style="margin-top:0; color:#98FB98; font-family: Segoe UI, Tahoma, sans-serif; font-size: 18px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 8px;">Предпросмотр сообщения</h3>';
